...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var setting: UIViewController? {
        return UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: AppViewController.classForCoder().description())
    }
    ...
    let images: [UIImage] = [#imageLiteral(resourceName: "navigation_bar_2"), #imageLiteral(resourceName: "navigation_bar_1")]
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        window?.rootViewController = UINavigationController(rootViewController: main!, preference: nil)
